...
public class CartItemServiceImpl implements CartItemService {
    ...
    @Override
    public PageResponse<ProductResponse> findCartProducts(Long userId, int page, int size) {
        List<ProductResponse> content = cartItemRepository.findProductsByUserId(userId, page, size);
